...
class JobController extends BaseController
{
    ...
    public function update(Job $job, JobRequest $request, BaseHttpResponse $response, StoreTagService $storeTagService)
    {
        if (! $request->has('employer_colleagues')) {
            $request->merge(['employer_colleagues' => []]);
        }
    ...
    public function destroy(Job $job, Request $request, BaseHttpResponse $response)
    {
        try {
            $job->delete();
