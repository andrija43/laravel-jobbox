...
class AccountJobController extends Controller
{
    ...
    {
        PageTitle::setTitle(__('Manage Jobs'));
    ...
    public function create(FormBuilder $formBuilder, BaseHttpResponse $response)
    {
        ...
        PageTitle::setTitle(__('Post a job'));
    ...
    public function edit(Job $job, FormBuilder $formBuilder, Request $request)
    {
    ...
    public function update(Job $job, AccountJobRequest $request, BaseHttpResponse $response, StoreTagService $storeTagService)
    {
        if (! $this->canManageJob($job)) {
            abort(404);
        }
    ...
    public function destroy(Job $job, BaseHttpResponse $response)
    {
        if (! $this->canManageJob($job)) {
            abort(404);
        }
