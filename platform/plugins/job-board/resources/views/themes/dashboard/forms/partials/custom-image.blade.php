<div class="image-box">
    ...
    <div class="preview-image-wrapper">
        <img
            class="preview_image"
            data-default-image="{{ $attributes['placeholder'] ?? RvMedia::getDefaultImage() }}"
            src="{{ RvMedia::getImageUrl($value, 'thumb', false, $attributes['placeholder'] ?? RvMedia::getDefaultImage()) }}"
