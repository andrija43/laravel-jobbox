            ...
            <div class="comment-log ws-nm">
                <div class="comment-log-title">
                    <div class="row">
                        <div class="col-md-6">
                            <label
                                class="bold-light m-xs-b hide-print">{{ trans('plugins/job-board::account.transactions') }}</label>
                        </div>
                        <div class="col-md-6 text-end">
                            <a
                                class="btn-trigger-add-credit"
                                href="#"
                            >{{ trans('plugins/job-board::account.add_credit') }}</a>
                        </div>
                    </div>
                </div>
                                    ...
                                    @foreach ($transactions as $transaction)
                                        <div class="item comment-log-item comment-log-item-date ui-feed__timeline">
                                            <div class="ui-feed__item ui-feed__item--message">
                                                <span
                                                    class="ui-feed__marker @if ($transaction->account_id) ui-feed__marker--user-action @endif"
                                                ></span>
                                                    ...
                                                    <div class="timeline__message-container">
                                                        <div class="timeline__inner-message">
                                                            <a
                                                                ...
                                                                href="#"
                                                            >
                                                                <span>{{ trans('plugins/job-board::account.added') }}
                                                                    {{ $transaction->credits }}
                                                                    {{ __('credit(s) by admin') }}
                                            ...
                                            <div
                                                ...
                                                id="history-line-{{ $transaction->id }}"
                                            >
