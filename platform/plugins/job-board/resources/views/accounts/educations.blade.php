...
>
    ...
    <div
        class="widget-body"
        id="education-histories"
    >
        <a
            class="btn-trigger-add-education"
            href="#"
            v-pre=""
        >{{ trans('plugins/job-board::account.add_education') }}</a>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">
                                            {{ trans('plugins/job-board::account.table.educations.school') }}</th>
                                        <th scope="col">
                                            {{ trans('plugins/job-board::account.table.educations.specialized') }}</th>
                                ...
                                <tbody>
                                    @foreach ($educations as $education)
                                        <tr>
                                            ...
                                            <td>{{ $education->ended_at ? $education->ended_at->format('Y-m-d') : trans('plugins/job-board::account.now') }}
                                            </td>
                                            <td
                                                class="text-center"
                                                style="width: 120px;"
                                            >
                                                <a
                                                    class="btn btn-icon btn-sm btn-warning me-1 btn-trigger-edit-education"
                                                    data-bs-toggle="tooltip"
                                                    data-section="{{ route('accounts.educations.edit-modal', [$education->id, $education->account_id]) }}"
...
{!! Form::modalAction(
    ...
    trans('plugins/job-board::account.edit_education'),
    'info',
    null,
    'confirm-edit-education-button',
