...
>
    <table class="table table-bordered setting-option">
        <thead>
            <tr>
                <th scope="col">#</th>
                <th scope="col">{{ trans('plugins/job-board::custom-fields.option.label') }}</th>
                <th
                    scope="col"
                    colspan="2"
                >{{ trans('plugins/job-board::custom-fields.option.value') }}</th>
            </tr>
        </thead>
    ...
    <button
        ...
        id="add-new-row"
        type="button"
    >{{ trans('plugins/job-board::custom-fields.option.add_row') }}</button>
</div>
